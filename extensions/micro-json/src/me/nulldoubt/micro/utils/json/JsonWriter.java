...
public class JsonWriter extends Writer {
	...
	public enum OutputType {
		...
		private static final Pattern javascriptPattern = Pattern.compile("^[a-zA-Z_$][a-zA-Z_$0-9]*$");
		private static final Pattern minimalNamePattern = Pattern.compile("^[^\":,}/ ][^:]*$");
		private static final Pattern minimalValuePattern = Pattern.compile("^[^\":,{\\[\\]/ ][^}\\],]*$");
