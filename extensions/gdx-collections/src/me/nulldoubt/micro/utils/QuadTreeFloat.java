...
import com.nulldoubt.micro.math.Rectangle;
import com.nulldoubt.micro.utils.Pool.Poolable;

/** A quad tree that stores a float for each point.
 * @author Nathan Sweet */
public class QuadTreeFloat implements Poolable {
	public static final int VALUE = 0, X = 1, Y = 2, DISTSQR = 3;
	...
	public int depth;
	public QuadTreeFloat nw, ne, sw, se;
