...
public class UITest extends GdxTest {
	...
	public void create () {
		...
		texture1 = new Texture(Micro.files.internal("data/badlogicsmall.jpg"));
		texture2 = new Texture(Micro.files.internal("data/badlogic.jpg"));
		...
		slider.addListener(new ChangeListener() {
			public void changed (ChangeEvent event, Actor actor) {
				Micro.app.log("UITest", "slider: " + slider.getValue());
			}
		});
		...
		checkBox.addListener(new ChangeListener() {
			public void changed (ChangeEvent event, Actor actor) {
				Micro.graphics.setContinuousRendering(checkBox.isChecked());
			}
		});
	}
	...
	public void render () {
		...
		fpsLabel.setText("fps: " + Micro.graphics.getFPS());
