...
public class BitmapFontAlignmentTest extends GdxTest {
	...
	public void create () {
		...
		font = new BitmapFont(Micro.files.getFileHandle("data/verdana39.fnt", FileType.Internal),
			Micro.files.getFileHandle("data/verdana39.png", FileType.Internal), false);
