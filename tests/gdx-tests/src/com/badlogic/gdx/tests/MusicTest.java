...
public class MusicTest extends GdxTest {
	...
	void setSong (Song song) {
		...
		default:
		case MP3_CLOCK:
			music = Micro.audio.newMusic(Micro.files.internal("data/60bpm.mp3"));
			songDuration = 5 * 60 + 4;
			break;
		case MP3:
			music = Micro.audio.newMusic(Micro.files.internal("data/8.12.mp3"));
			songDuration = 183;
			break;
		case OGG:
			music = Micro.audio.newMusic(Micro.files.internal("data/8.12.ogg"));
			songDuration = 183;
			break;
		case WAV:
			...
			break;
		case PCM8:
			music = Micro.audio.newMusic(Micro.files.internal("data/8.12.loop-8bit.wav"));
			songDuration = 4;
			break;
		}
	...
	@Override
	public void resume () {
		System.out.println(Micro.graphics.getDeltaTime());
	}
...
// }
	...
	private Drawable getDrawable (String path) {
		return new TextureRegionDrawable(new TextureRegion(new Texture(Micro.files.internal(path))));
	}
}
