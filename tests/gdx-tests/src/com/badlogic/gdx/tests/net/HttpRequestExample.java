...
public class HttpRequestExample extends GdxTest {
	...
	public void create () {
		...
		Micro.net.sendHttpRequest(request, new HttpResponseListener() {
			@Override
			public void handleHttpResponse (HttpResponse httpResponse) {
				Micro.app.log("HttpRequestExample", "response: " + httpResponse.getResultAsString());
			}

			@Override
			public void failed (Throwable t) {
				Micro.app.error("HttpRequestExample", "something went wrong", t);
			}

			@Override
			public void cancelled () {
				Micro.app.log("HttpRequestExample", "cancelled");
			}
		});
	}
}
