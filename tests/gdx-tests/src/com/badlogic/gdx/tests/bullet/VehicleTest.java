...
public class VehicleTest extends BaseBulletTest {
	...
	public void create () {
		...
		final Model chassisModel = objLoader.loadModel(Micro.files.internal("data/car.obj"));
		...
		final Model wheelModel = objLoader.loadModel(Micro.files.internal("data/wheel.obj"));
		...
		Texture checkboard = new Texture(Micro.files.internal("data/g3d/checkboard.png"));
	...
	@Override
	public void update () {
		final float delta = Micro.graphics.getDeltaTime();
