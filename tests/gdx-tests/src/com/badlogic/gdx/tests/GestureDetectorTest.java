...
public class GestureDetectorTest extends GdxTest implements ApplicationListener {
	...
	class CameraController implements GestureListener {
		...
		public boolean tap (float x, float y, int count, int button) {
			Micro.app.log("GestureDetectorTest", "tap at " + x + ", " + y + ", count: " + count);
			return false;
		}

		@Override
		public boolean longPress (float x, float y) {
			Micro.app.log("GestureDetectorTest", "long press at " + x + ", " + y);
			return false;
		}

		@Override
		public boolean fling (float velocityX, float velocityY, int button) {
			Micro.app.log("GestureDetectorTest", "fling " + velocityX + ", " + velocityY);
			flinging = true;
		...
		public boolean panStop (float x, float y, int pointer, int button) {
			Micro.app.log("GestureDetectorTest", "pan stop at " + x + ", " + y);
			return false;
		}
		...
		public void update () {
			if (flinging) {
				velX *= 0.98f;
				velY *= 0.98f;
				camera.position.add(-velX * Micro.graphics.getDeltaTime(), velY * Micro.graphics.getDeltaTime(), 0);
	...
	public void create () {
		...
		Micro.input.setInputProcessor(gestureDetector);
	}
