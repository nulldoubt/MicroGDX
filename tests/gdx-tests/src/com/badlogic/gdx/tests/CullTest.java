...
public class CullTest extends GdxTest implements ApplicationListener {
	...
	public void create () {
		...
		cam = new OrthographicCamera(45, 45 * (Micro.graphics.getWidth() / (float) Micro.graphics.getHeight()));
	...
	public void render () {
		...
		batch.begin();
		font.draw(batch, "visible: " + visible + "/100" + ", fps: " + Micro.graphics.getFPS(), 0, 20);
		batch.end();
	}
