...
public class SimpleDecalTest extends GdxTest {
	...
	public void create () {
		...
		camera = new PerspectiveCamera(45, Micro.graphics.getWidth(), Micro.graphics.getHeight());
		camera.near = 1;
		camera.far = 300;
		...
		TextureRegion[] textures = {new TextureRegion(new Texture(Micro.files.internal("data/egg.png"))),
			new TextureRegion(new Texture(Micro.files.internal("data/sys.png"))),
