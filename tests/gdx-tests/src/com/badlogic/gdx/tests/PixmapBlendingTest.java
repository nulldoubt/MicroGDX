...
public class PixmapBlendingTest extends GdxTest {
	...
	public void create () {
		...
		transform.setToTranslation(0, Micro.graphics.getHeight(), 0);
		transform.mul(new Matrix4().setToScaling(1, -1, 1));
		spriteBatch.setTransformMatrix(transform);

		pixS1 = new Pixmap(Micro.files.internal("data/test4.png"));
		pixS2 = new Pixmap(Micro.files.internal("data/test3.png"));
