...
public class VoxelTest extends GdxTest {
	...
	public void create () {
		...
		Texture texture = new Texture(Micro.files.internal("data/g3d/tiles.png"));
	...
	public void render () {
		...
		spriteBatch.begin();
		font.draw(spriteBatch, "fps: " + Micro.graphics.getFPS() + ", #visible chunks: " + voxelWorld.renderedChunks + "/"
