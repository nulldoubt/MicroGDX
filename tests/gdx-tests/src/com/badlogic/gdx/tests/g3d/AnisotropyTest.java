...
public class AnisotropyTest extends GdxTest {
	...
	public void create () {
		...
		brick = new Texture(Micro.files.internal("data/g3d/materials/brick_diffuse_01.png"), true);
		...
		Micro.gl.glClearColor(0, 0.2f, 0.2f, 1);
	}
	...
	private void changeAnisotropy () {
		...
		Micro.app.log("anisotropic value", Float.toString(value));
	}

	@Override
	public void render () {
		if (Micro.input.isKeyJustPressed(Input.Keys.SPACE)) changeAnisotropy();
