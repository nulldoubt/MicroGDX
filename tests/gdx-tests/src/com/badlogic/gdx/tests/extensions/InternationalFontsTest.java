...
public class InternationalFontsTest extends GdxTest {
	...
	@Override
	public void create () {
		FreeTypeFontGenerator generator = new FreeTypeFontGenerator(Micro.files.internal("data/unbom.ttf"));
		...
		generator = new FreeTypeFontGenerator(Micro.files.internal("data/russkij.ttf"));
		cyrillicFont = generator.generateFont(parameter);
		generator.dispose();

		parameter.characters = "วรณยุ�?ต์";

		generator = new FreeTypeFontGenerator(Micro.files.internal("data/garuda.ttf"));
