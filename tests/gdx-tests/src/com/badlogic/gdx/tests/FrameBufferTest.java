...
public class FrameBufferTest extends GdxTest {
	...
	public void render () {
		frameBuffer.begin();
		Micro.gl20.glViewport(0, 0, frameBuffer.getWidth(), frameBuffer.getHeight());
		Micro.gl20.glClearColor(0f, 1f, 0f, 1);
		...
		Micro.gl20.glViewport(0, 0, frameBuffer.getWidth(), frameBuffer.getHeight());
		Micro.gl20.glClearColor(1f, 1f, 0f, 1);
		Micro.gl20.glClear(GL20.GL_COLOR_BUFFER_BIT | GL20.GL_STENCIL_BUFFER_BIT);

		Micro.gl20.glEnable(GL20.GL_STENCIL_TEST);

		Micro.gl20.glColorMask(false, false, false, false);
		Micro.gl20.glDepthMask(false);
		Micro.gl20.glStencilFunc(GL20.GL_NEVER, 1, 0xFF);
		Micro.gl20.glStencilOp(GL20.GL_REPLACE, GL20.GL_KEEP, GL20.GL_KEEP);

		Micro.gl20.glStencilMask(0xFF);
		Micro.gl20.glClear(GL20.GL_STENCIL_BUFFER_BIT);

		meshShader.bind();
		stencilMesh.render(meshShader, GL20.GL_TRIANGLES);

		Micro.gl20.glColorMask(true, true, true, true);
		Micro.gl20.glDepthMask(true);
		Micro.gl20.glStencilMask(0x00);
		Micro.gl20.glStencilFunc(GL20.GL_EQUAL, 1, 0xFF);

		meshShader.bind();
		mesh.render(meshShader, GL20.GL_TRIANGLES);

		Micro.gl20.glDisable(GL20.GL_STENCIL_TEST);
