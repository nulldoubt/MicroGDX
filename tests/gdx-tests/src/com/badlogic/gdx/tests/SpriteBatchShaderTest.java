...
// spriteBatch.drawText(font, "all hail and another this is a test", 200, 200, Color.WHITE);
	...
	public void create () {
		...
		for (int i = 0; i < coords.length; i += 2) {
			coords[i] = (int)(Math.random() * Micro.graphics.getWidth());
			coords[i + 1] = (int)(Math.random() * Micro.graphics.getHeight());
			coords2[i] = (int)(Math.random() * Micro.graphics.getWidth());
			coords2[i + 1] = (int)(Math.random() * Micro.graphics.getHeight());
		}
	}
