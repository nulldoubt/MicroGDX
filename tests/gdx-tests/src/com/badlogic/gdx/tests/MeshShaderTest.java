...
public class MeshShaderTest extends GdxTest {
	...
	public void create () {
		...
		texture = new Texture(Micro.files.internal("data/bobrgb888-32x32.png"));
	}
	...
	@Override
	public void render () {
		angle += Micro.graphics.getDeltaTime() * 45;
		matrix.setToRotation(axis, angle);

		Mesh meshToDraw = Micro.input.isButtonPressed(0) ? meshCustomVA : mesh;
		...
		Micro.gl20.glEnable(GL20.GL_TEXTURE_2D);
		Micro.gl20.glEnable(GL20.GL_BLEND);
		Micro.gl20.glBlendFunc(GL20.GL_SRC_ALPHA, GL20.GL_ONE_MINUS_SRC_ALPHA);
		texture.bind();
		shader.bind();
